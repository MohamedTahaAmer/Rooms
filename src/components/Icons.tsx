...
export const Icons = {
  ...
  loader: (props: LucideProps) => (
    <svg {...props} fill="#ecb134" viewBox="0 0 399.389 399.389">
      <path d="M340.896 58.489C303.18 20.773 253.031.001 199.693.001c-53.34 0-103.487 20.771-141.204 58.488C20.772 96.207 0 146.355 0 199.694c0 53.34 20.772 103.489 58.49 141.206 37.717 37.717 87.864 58.488 141.204 58.488 53.339 0 103.486-20.771 141.205-58.488 37.717-37.717 58.49-87.865 58.49-141.206-.002-53.339-20.776-103.487-58.493-141.205zm-12.835 12.837c34.289 34.289 53.172 79.878 53.172 128.368h-41.148c0-77.412-62.979-140.391-140.391-140.391-4.593 0-9.134.229-13.615.662v-41.31c4.508-.332 9.049-.5 13.615-.5 48.49 0 94.077 18.883 128.367 53.171zM199.693 321.931c-67.401 0-122.236-54.835-122.236-122.236S132.292 77.458 199.693 77.458 321.93 132.293 321.93 199.694s-54.836 122.237-122.237 122.237z"></path>
    </svg>
  ),
  skeleton: (props: LucideProps) => (
    <svg
      {...props}
      viewBox="0 0 24 24"
      fill="none"
